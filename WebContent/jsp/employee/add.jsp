...
<s:form id="saveEmpForm" action="employee_save" method="post" namespace="/"  theme="simple">
...
<tr>
<td>所属部门：</td>
<td><s:select name="dept.did" list="list" listKey="did"  listValue="dname" headerKey="" headerValue="--请选择--"/></td>
<td>编号：</td>
